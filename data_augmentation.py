...
train_datagen = ImageDataGenerator(
    rescale=1. / 255, # we prefer to work with values between 0-1 and not 0-255 because it will be easier for the modoles calculation
...
# we prefer to work with values between 0-1 and not 0-255 because it will be easier for the modoles calculation
validation_datagen = ImageDataGenerator(rescale=1. / 255)

train_generator = train_datagen.flow_from_directory(
    train_data_dir,
    color_mode='grayscale', # I chose to use grayscle beacuse color is not important for my models accuracy and using RGB will make it much slower
